...
To understand what metasploit does in the background, we'll set a proxy. First let's terminate our current session.
...
I made a diagram on photoshop, so you will understand what we're doing now.
